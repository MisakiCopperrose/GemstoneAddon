...
public enum RubyArmorMaterial implements IArmorMaterial {
    ...
    // Will it make refer to ruby_layer_1 and ~2, then durability, protection value,
    // equip sound, toughness, the repair material and knockback resistance
    ...
    RubyArmorMaterial(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability,
