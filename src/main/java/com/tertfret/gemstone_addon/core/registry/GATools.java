...
public class GATools {
    ...
    public static final RegistryObject<PickaxeItem> TOPAZ_PICKAXE = ITEMS.register("topaz_pickaxe",
            () -> new PickaxeItem(TopazItemTier.TOPAZ, 0, -2.8f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<AxeItem> TOPAZ_AXE = ITEMS.register("topaz_axe",
            () -> new AxeItem(TopazItemTier.TOPAZ, 5, -3.1f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<HoeItem> TOPAZ_HOE = ITEMS.register("topaz_hoe",
            () -> new HoeItem(TopazItemTier.TOPAZ, -3, -1.0f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<ShovelItem> TOPAZ_SHOVEL = ITEMS.register("topaz_shovel",
            () -> new ShovelItem(TopazItemTier.TOPAZ, 0, -3.0f, new Item.Properties().group(GemstoneAddon.TAB)));

    // Amethyst tools
    public static final RegistryObject<SwordItem> AMETHYST_SWORD = ITEMS.register("amethyst_sword",
            () -> new SwordItem(AmethystItemTier.AMETHYST, 2, -2.2f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<PickaxeItem> AMETHYST_PICKAXE = ITEMS.register("amethyst_pickaxe",
            () -> new PickaxeItem(AmethystItemTier.AMETHYST, 0, -2.8f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<AxeItem> AMETHYST_AXE = ITEMS.register("amethyst_axe",
            () -> new AxeItem(AmethystItemTier.AMETHYST, 5, -3.1f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<HoeItem> AMETHYST_HOE = ITEMS.register("amethyst_hoe",
            () -> new HoeItem(AmethystItemTier.AMETHYST, -3, -1.0f, new Item.Properties().group(GemstoneAddon.TAB)));

    public static final RegistryObject<ShovelItem> AMETHYST_SHOVEL = ITEMS.register("amethyst_shovel",
            () -> new ShovelItem(AmethystItemTier.AMETHYST, 0, -3.0f, new Item.Properties().group(GemstoneAddon.TAB)));
